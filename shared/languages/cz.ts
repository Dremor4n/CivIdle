export const CZ = {
   ...
   Beijing: "Peking",
   BigBen: "Big Ben",
   BigBenDesc: "+2 vědy ze zaneprázdněných pracovníků. Zvolte ideologii svého impéria, s každou volbou odemkněte další vylepšení.",
   Biplane: "Dvouplošník",
   ...
   ConfirmYes: "Ano",
   Confucius: "Konfucius",
   ConfuciusDescV2: "+%{value} Vědy ze všech pracovníků, pokud je více než 50% pracovníků zaneprázdněných a méně než polovina z nich pracuje v přepravě.",
   ...
   ElectrificationStatusNoPowerV2: "Nedostatek elektřiny",
   ElectrificationStatusNotActive: "Není aktivní",
   ElectrificationStatusV2: "Stav elektrifikace",
   ...
   FeatureRequireQuaestorOrAbove: "Tato možnost vyžaduje úroveň Kvestora nebo vyšší",
   Festival: "Festival",
   ...
   FreeThisWeekDescHTML: "<b>Každý týden</b>, lze jedno z prémiových měst hrát zdarma. Tento týden je to město <b>%{city}</b>",
   Frigate: "Fregata",
   ...
   LoggingCamp: "Dřevorubecká chýše",
